print("Welcome to the Python gene module created by Souradeep Das.\nYou can perform a variety of operations on gene sequences including sequence inversion, complementary strand production, as well as transcription and translation")
phe=['Phe','UUU','UUC']
...
stop=['UAA','UAG','UGA']
amino=[gly,ala,val,leu,ile,pro,asp,glu,asn,gln,lys,arg,ser,thr,cys,met,phe,tyr,his,trp]
def rev(sample_string):
	"""Reverses the sequence of characters in a string.

	Returns the string formed by reversing the order of characters in string 'sample_string'.
	Useful for converting a 3\'->5\' sequence into a 5\'->3\' sequence"""
	k=''
...
#*
#*
#Well.... some of us have really a busy schedule and cannot afford patience to type the correct spellings sometimes. For them we introduce a manual  correction recognition feature.
traslate=translate
